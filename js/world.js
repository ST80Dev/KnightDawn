...
const World = {
  ...
  generate(seed) {
    ...
    // (densità ~1/4 della vecchia) ma ogni seme cresce per mini-BFS in un
    // grumo di 3-5 tile compatibili → variazioni leggibili, non isolate.
    ...
    const growCluster = (sx, sy, fromList, to, sizeMin, sizeMax) => {
      ...
      while (qi < queue.length && placed < target) {
        ...
        // shuffle → grumi a forma irregolare, non a rombo perfetto
