...
const Sprites = {
  ...
  bitmaps: {
    ...
    // Lupo: TESTA simbolica, ringhiante, orecchie dritte, occhi ambra, zanne.
    lupo: [
      '..oo........oo..',
      '.odmo......odmo.',
      '.odmmo....odmmo.',
    ...
    // Cinghiale: TESTA simbolica, muso largo, zanne ricurve, occhietti.
    cinghiale: [
      '..oo......oo...',
      '.odmo....odmo..',
      '.odmmoooommmo..',
    ...
    // Orso: TESTA di PROFILO, muso a destra, orecchio tondo, naso, zanne.
    // Orso: FACCIA frontale, orecchie tonde, occhi, muso chiaro col naso.
    orso: [
      '.oo......oo..',
      'odmo....odmo.',
      'odmlo..odmlo.',
    ...
    // Drago: TESTA di profilo CONNESSA, corno all'indietro, occhio, fauci
    // aperte con il fuoco come dettaglio interno (non un vuoto che spezza).
    drago: [
      '..o...............',
      '..oo..............',
      '.odmo.ooo.........',
    ...
    // coda (24x14).
    // Chimera/Bestia di leggenda: TESTA cornuta simbolica, occhi ardenti, zanne.
    chimera: [
      'a..o......o..a.',
      'oa.odo..odo.ao.',
      '.oaodmo.odmoao.',
  ...
  palettes: {
    ...
    drago:      { o:'#1a0c0a', d:'#5a1c14', m:'#8a2a1a', l:'#b04a26', e:'#e0b020', w:'#6a201a', n:'#e8dcc0', f:'#e8c020', r:'#d05018' },
    cinghiale:  { o:'#160f08', d:'#33240f', m:'#5a4426', l:'#7c603a', e:'#caa030', w:'#e0d8c0', n:'#160f08' },
  ...
  byCategoria: {
    ...
    lupo: 'lupo', cinghiale: 'cinghiale', orso: 'orso',
