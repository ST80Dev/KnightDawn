...
const Sprites = {
  ...
  bitmaps: {
    ...
    // Umano (bandito/predone/soldato): incappucciato, volto in ombra.
    umano: [
      '.....oddddo.....',
      '...odmmmmmmmdo..',
      '..odmmmmmmmmmdo.',
  ...
  palettes: {
    ...
    umano:      { o:'#140a04', d:'#3a2611', m:'#6e4a22', l:'#9a6a30', s:'#c69a68', r:'#7a1414' },
    lupo:       { o:'#16140f', d:'#3a352c', m:'#6a6052', l:'#8e8474', e:'#d8a830', w:'#e0d8c8' },
