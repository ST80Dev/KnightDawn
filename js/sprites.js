...
const Sprites = {
  ...
  bitmaps: {
    ...
    // Lupo: creatura FRONTALE iconica, orecchie dritte, occhi ambra, zanne.
    lupo: [
      '..oo......oo..',
      '.odmo....odmo.',
      '.odmmo..odmmo.',
    ...
    // Cinghiale: creatura FRONTALE, muso largo, zanne ricurve, occhietti.
    cinghiale: [
      '..oo......oo..',
      '.odmo....odmo.',
      '.odmmoooodmmo.',
    ...
    // Orso: creatura FRONTALE eretta, orecchie tonde, muso chiaro, pancia.
    orso: [
      '..oo......oo..',
      '.odmo....odmo.',
      '.odmmoooodmmo.',
    ...
    // Drago: creatura FRONTALE iconica, ali spiegate, corna, coda, occhi.
    drago: [
      '.....o....o.....',
      '....odo..odo....',
      '....odmoodmo....',
    ...
    // coda (24x14).
    // Chimera/Bestia di leggenda: creatura FRONTALE cornuta, occhi ardenti,
    // criniera, zanne.
    chimera: [
      'a..o......o..a',
      '.a.odo..odo.a.',
